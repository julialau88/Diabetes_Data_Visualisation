...
vegaEmbed("#gender", vg_1).then(function(result) {
}).catch(console.error);
...
vegaEmbed("#isopleth", vg_3).then(function(result) {
}).catch(console.error);

var vg_4 = "causesOfDeath.vg.json";
vegaEmbed("#death", vg_4).then(function(result) {
}).catch(console.error);

var vg_5 = "diabetesPrediction.vg.json";
vegaEmbed("#predict", vg_5).then(function(result) {
}).catch(console.error);